...
TEST(Cluster, BasicTableOperations) {
  ...
  EXPECT_ROWS(
      m, table_name,
      {absl::StrCat(column_family_name, ".", "TEST_ROW", ".", column_qualifier),
       t, "TEST_ROW_VALUE"});
}
